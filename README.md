...
- `host_vars/<host>/vars.yml` defines host-specific non-secret values such as `ansible_user`, `ansible_group`, Python interpreter, and `config_files_host` for config files rendered only on that host.
